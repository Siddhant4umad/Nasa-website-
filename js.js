...
class NASAWebsite {
    ...
    initializeComponents() {
        this.handleDOMReady();
        // Remove redundant DOMContentLoaded in setupEventListeners
        // this.setupEventListeners() will not re-call handleDOMReady
        ...
        // Remove setupAnimations (ripple keyframes are in CSS)
        this.logWelcomeMessage();
    }

    // Event Listeners Setup
    setupEventListeners() {
        // Remove redundant DOMContentLoaded event
        // document.addEventListener('DOMContentLoaded', () => {
        //     this.handleDOMReady();
        // });
    ...
    handleDOMReady() {
        this.elements = {
            ...
            // Remove .about-text (not in CSS), use .about-description if needed
            animatedElements: document.querySelectorAll('.mission-card, .news-card, .gallery-item, .about-description, .about-image'),
    ...
    // Scroll Effects
    setupScrollEffects() {
        // Remove unused this.lastScrollY
    ...
    handleScroll() {
        ...
        // Remove this.lastScrollY = currentScrollY;
    }
